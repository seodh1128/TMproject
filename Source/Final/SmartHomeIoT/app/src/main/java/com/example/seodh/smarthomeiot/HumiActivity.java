...
public class HumiActivity extends Activity {
    ...
    public void onCreate(Bundle saveInstanceState) {
        ...
        Toast.makeText (this, "습도센서 상태 확인 페이지입니다",Toast.LENGTH_LONG).show();
    ...
    public void humi() {
        ...
        dashboardCall.enqueue(new Callback<List<Dashboard>>() {
            ...
            public void onResponse(Call<List<Dashboard>> call, Response<List<Dashboard>> response) {
                ...
                Dashboard d = result.get(3);    //result.get(0)이 쿼리문에 지정한 값들의 한줄을 읽어오는거 나머지 센서3개는 get1,2,3해주면됌
